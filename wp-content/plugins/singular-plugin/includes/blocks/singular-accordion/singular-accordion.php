<?php
// Register the block
function singular_plugin_accordion_acf_init() {
  if ( function_exists( 'acf_register_block_type' ) ) {
    ...
    acf_register_block_type(
      array(
        ...
        'render_callback' => 'singular_plugin_acf_block_render_callback',
...
add_action( 'acf/init', 'singular_plugin_accordion_acf_init' );

// Enqueue front-end styles for this block type
function singular_plugin_accordion_styles() {
  wp_enqueue_style( 'singular_plugin_accordion_css', plugin_dir_url( __FILE__ ).'styles.css' );
  wp_enqueue_script( 'singular_plugin_accordion_js', plugin_dir_url( __FILE__ ).'scripts.js', array( 'jquery' ) );
}
add_action( 'wp_enqueue_scripts', 'singular_plugin_accordion_styles' );
