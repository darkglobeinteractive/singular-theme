...
function singular_custom_block_styles() {
  ...
  wp_enqueue_script( 'multi-slider-js', get_template_directory_uri().'/blocks/multi-slider/multi-slider.js', array( 'jquery' ), singular_theme_filemtime('/blocks/multi-slider/multi-slider.js' ) );
